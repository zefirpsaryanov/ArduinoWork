...
//#define TFT_MOSI 23
//#define TFT_SCLK 18
#define TFT_CS   14 //15  // Chip select control pin
#define TFT_DC   27 //2  // Data Command control pin
#define TFT_RST  33 //4  // Reset pin (could connect to RST pin)
//#define TFT_RST  -1  // Set TFT_RST to -1 if display RESET is connected to ESP32 board RST

//#define TFT_BL   32  // LED back-light (only for ST7789 with backlight control pin)

#define TOUCH_CS 12 //21     // Chip select pin (T_CS) of touch screen
