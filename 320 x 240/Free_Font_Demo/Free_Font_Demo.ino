...
{
  tft.drawLine(x - 159, y + 119, x + 159 , y + 119, TFT_WHITE);
  tft.drawLine(x - 159, y - 119, x - 159, y + 119, TFT_RED);
  tft.drawLine(x - 159, y - 119, x + 159 , y - 119, TFT_GREEN);
  tft.drawLine(x + 159, y - 119, x + 159, y + 119, TFT_PINK);
