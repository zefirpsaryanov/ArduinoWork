...
U8GLIB_SH1106_128X64 u8g(U8G_I2C_OPT_NONE);  // I2C / TWI LED)


// setup input buffer
#define LINE_MAX 18
uint8_t line_buf[LINE_MAX] = "ABCDEFGHIJKLMNOPQR";
uint8_t line_pos = 0;
...
// line height, which matches the selected font (7x13)
#define LINE_PIXEL_HEIGHT 13
