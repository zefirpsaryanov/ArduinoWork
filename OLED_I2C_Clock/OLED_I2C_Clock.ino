...
void loop()
{
  ...
  dd < 10 ? ddstr = "0" + String(dd) : ddstr = String(dd);
  mm < 10 ? mmstr = "0" + String(mm) : mmstr = String(mm);
  yy < 10 ? yystr = "0" + String(yy) : yystr = String(yy);

  timeToString = strHH + "." + strMM + "." + strSS;
  dateToString = ddstr + "." + mmstr + "." + yystr;
  ...
  myOLED.print(dateToString, CENTER, 16); // date
