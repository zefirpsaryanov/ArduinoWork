...
void drawMainDisplay()
{
  ...
  tft.drawFastHLine(0, 0, 240, ILI9341_CYAN);
  tft.drawFastHLine(0, 240, 240, ILI9341_CYAN);
  tft.drawFastHLine(0, 319, 240, ILI9341_CYAN);

  for (int i = 0; i < 5; i++)
  {
    tft.drawCircle(clockCenterX, clockCenterY, 119 - i, ILI9341_CYAN);
  }

  for (int i = 2; i < 5; i++)
  {
    tft.drawCircle(clockCenterX, clockCenterY, i, ILI9341_CYAN);
  }
